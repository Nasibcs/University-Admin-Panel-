      ...
      <div className="p-6 max-w-7xl mx-auto dark:bg-gray-800">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8 dark:bg-gray-800">
          <form
            ...
            className="space-y-4 bg-gray-50 p-6 rounded-lg border border-gray-200 dark:bg-gray-800 "
          >
            ...
            <div className="flex justify-end space-x-3 pt-4">
              ...
              <button
                type="submit"
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-indigo-600"
              >
                {editId ? (
                  <>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 dark:bg-gray-800">
          <h3 className="text-2xl font-bold text-gray-800 border-b pb-2 flex items-center dark:text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 dark:text-indigo-500 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {faculties.length === 0 ? (
            ...
            <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-6">
              {faculties.map((faculty) => (
                <div
                  key={faculty.id}
                  className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden relative"
                >
                  ...
                  <div className=" bg-gradient-to-r from-indigo-600 to-blue-500 p-4 text-white">
                    <h4 className="text-xl font-bold dark:text-gray-100">{faculty.name}</h4>
                  </div>
                  
                  <div className="p-4 dark:bg-gray-800">
                    <div className="flex items-center mb-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className=" dark:text-gray-100 h-5 w-5 text-gray-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                      <p className="text-gray-700 dark:text-gray-100"><span className="font-medium">Dean:</span> {faculty.dean}</p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-3 rounded-md mb-4 dark:bg-gray-800">
                      <p className="text-sm text-gray-700 italic dark:text-yellow-400">{faculty.description}</p>
                    </div>
